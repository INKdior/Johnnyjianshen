...
<html lang="en">
  <head>
    ...
    <script src="/Public/Validform_v5.3.2.js"></script>
...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
    <form action="/index.php/Admin/Add/addcoupon" enctype="multipart/form-data" method="post" >    
        <table>
        
        <!--    名字 :<input type="text" name="coupon_name" value="" /><br/>
