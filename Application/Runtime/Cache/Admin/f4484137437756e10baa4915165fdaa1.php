...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <form method="post"  action="<?php echo U('index/add_admin');?>" onsubmit="" id='subform' enctype="multipart/form-data">
            <table>
                <tr>
                    <td>姓名：</td>
                    <td >
                ...
                <tr>
                    <td>权限：</td>
                    <td>
                        <select style="margin-left:7px;width:20%" class="form-control" name="level"> 
