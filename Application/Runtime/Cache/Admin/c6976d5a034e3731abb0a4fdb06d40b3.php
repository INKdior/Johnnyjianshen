...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <table>
            <tr>
                <td width="10%">微信</td><td ><?php echo ($re['wxname']); ?></td>
            </tr>
            <tr>
                <td>头像</td> <td ><img width='100px' height='100px'src="<?php echo ($re['picture_url']); ?>"></td>
            </tr>

            <tr>
                <td>真实姓名</td><td ><?php echo ($re['autonym']); ?></td>
            </tr>
            <tr>
                <td>收货地址</td>
                <td>
                    <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?><p>
                            (<?php echo ($key+1); ?>)
                            <span>收货人：<?php echo ($ad['name']); ?></span>
                            <span>电话：<?php echo ($ad['tel']); ?></span>
                            <span>地址：<?php echo ($ad['addr']); ?></span>
                        </p><?php endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
            <tr>
                <td>手机</td> <td ><?php echo ($re['tel']); ?></td>
            </tr> 
            <tr>
                <td>优惠卷</td>
                <td class="clearfix">
                    <label><a class="bj_btn" href="<?php echo U('admin/index/user_coupon',array('share'=>$re['openid']));?>">查看已分享的优惠券</a></label>
                    <br>
                    <label><a class="bj_btn" href="<?php echo U('admin/index/user_coupon',array('user'=>$re['openid']));?>">查看已领取的优惠券</a></label>
                </td>
            </tr>
            <tr>
                <td >订单</td> 
                <td>
                    <a class="bj_btn" href="<?php echo U('admin/index/order',array('openid'=>$re['openid']));?>">查看</a>    
                </td>
            </tr>   
            <tr>
                <td >用户余额</td> 
