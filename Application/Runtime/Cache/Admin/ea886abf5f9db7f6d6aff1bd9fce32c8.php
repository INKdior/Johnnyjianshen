...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class='opreate' id="<?php echo ($vo['delivery_id']); ?>">     
                    <td id="order_id" value="<?php echo ($vo['order_id']); ?>"><center><?php echo ($vo['order_id']); ?></center></td>
                    <!-- <td value="<?php echo ($vo['paied']); ?>" id="paied"><center><?= $vo['paied'] == '1' ? '已完成支付' : '未支付' ?></center></td> -->
                    ...
                    <!-- <td value="<?php echo ($vo['price']); ?>" id="price"><center><?php echo ($vo['price']); ?></center></td> -->
                    ...
                    <td value="<?php echo ($vo['receiver']); ?>" id="receiver"><?php echo ($vo['tel']); ?></td>
