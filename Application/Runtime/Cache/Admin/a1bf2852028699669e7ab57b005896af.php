    ...
    <div class="table_con">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <img style="float:left;margin:10px" width='150px' height='100px' src="/Public/img/photo.gif">
...
<script type="text/javascript">
    ...
    $('#sub').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo U('index/add_goods');?>",
            type: "post",
            dataType: "json",
            data: {priceWay:priceWay,data:formData},
            complete: function() {
                alert('添加成功');
                window.location.href = "<?php echo U('index/goodslist');?>";
            }
        })
    })
    function check() {
