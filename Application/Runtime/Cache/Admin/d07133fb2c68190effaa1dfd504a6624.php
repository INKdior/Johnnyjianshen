...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <form method="post"  action="<?php echo U('index/add_delivery');?>" onsubmit="" id='subform' enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    <td>账号：</td>
                    <td >
                        <input name="account" type="text" value="<?php echo ($data['account']); ?>">
                    </td>
                </tr>
                <tr>
                    <td>密码：</td>
