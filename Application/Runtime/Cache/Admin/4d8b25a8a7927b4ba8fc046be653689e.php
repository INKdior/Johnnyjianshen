...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <form method="post"  action="<?php echo U('index/xg_banner');?>" onsubmit="" id='subform' enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr >
                <td width="20%">图片：<br><label>(规格：375x197)</label></td>  
                <td width="80%">
                    <img width='100px' style="float:left;margin:10px;" height='100px' src="<?php echo ($data['imgurl']); ?>">
                    ...
                    <input id="filePath" type="hidden" name="file_path" >
                </td>
            <tr>
