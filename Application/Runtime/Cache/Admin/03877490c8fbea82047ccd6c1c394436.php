...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="add_cp">
        <form method="post" action="<?php echo U('index/coupon_details');?>" onsubmit="" id='subform'>
            <input class="btn btn-default btn-sm" type="submit" value="添加优惠卷" /> 
        </form>
    </div>
    <div class="table_con">
        <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><img width='100px' height='100px'src="<?php echo ($vo['imgurl']); ?>">
                    <!-- <td><?php echo ($vo['price']); ?></td> -->
                    <td><?php echo ($vo['deadline']); ?></td>
                    <td  width="20%">
                        <a class="bj_btn" href="<?php echo U('admin/index/coupon_details',array('id'=>$vo['id']));?>">修改</a>
                        <a id="del" class="del_btn" href="javascript:" onclick=del("<?php echo U('admin/index/del',array('id'=>$vo['id'],'key'=>'coupon'));?>")>删除</a>    
                    </td>
                    <td><?= ($vo['status'] == 'N') ? '使用中' : '已作废' ?></td>
