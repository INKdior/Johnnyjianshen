    ...
    <div class="table_con">
        <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>     
                    ...
                    <td value="<?php echo ($vo['pay_for']); ?>" id="pay_for"><center><text style="color:red"><?php echo ($vo['rest']); ?>天</text></center></td>
                    <td value="<?php echo ($vo['or_time']); ?>" id="or_time"><center><?php echo ($vo['order_time']); ?></center></td>            
                    <td value="<?php echo ($vo['or_time']); ?>" id="or_time"><center><?php echo ($vo['or_time']); ?></center></td>
                    <td value="<?php echo ($vo['or_time']); ?>" id="or_time"><center><?php echo ($vo['xd_time']); ?></center></td>
