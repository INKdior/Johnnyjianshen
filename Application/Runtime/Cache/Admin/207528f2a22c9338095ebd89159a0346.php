...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="add_cp">
        <form method="post"  action="<?php echo U('index/search');?>" onsubmit="" id='subform'>
    ...
    <div class="table_con">
        <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><img width='100px' height='100px'src="<?php echo ($vo['picture_url']); ?>"></td>
                <td ><?php echo ($vo['autonym']); ?></td>
                <td ><?php echo ($vo['address']); ?></td>
                <td ><?php echo ($vo['tel']); ?></td>
                
                <td  width="20%">
                    <a  class="bj_btn" href="<?php echo U('admin/index/vipdetails',array('id'=>$vo['id']));?>">查看</a>
                 <!--    <a  id="del" class="del_btn" href="javascript:" onclick=del("<?php echo U('admin/index/delvip',array('id'=>$vo['id']));?>")>删除</a>  -->   
                </td>
