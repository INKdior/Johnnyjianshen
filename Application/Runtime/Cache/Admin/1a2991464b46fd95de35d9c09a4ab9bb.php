...
<div id="frameBord" name="frameBord"><div class="main-content">
    ...
    <div class="table_con">
        <table>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($key == 'refund_count') { echo "<tr>"; echo "<td>退还次数</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'refund_fee') { echo "<tr>"; echo "<td>退还费用</td><td>￥".($vo/100)."元</td>"; echo "</tr>"; } else if($key == 'trade_state') { if($vo == 'NOTPAY') { echo "<tr>"; echo "<td>状态</td><td>订单未支付</td>"; echo "</tr>"; } } else if($key == 'refund_recv_accout_0') { echo "<tr>"; echo "<td>退还账户</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'refund_status_0') { echo "<tr>"; echo "<td>退还状态</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'refund_success_time_0') { echo "<tr>"; echo "<td>退还时间</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'time_end') { echo "<tr>"; echo "<td>付款时间</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'return_msg') { echo "<tr>"; echo "<td>消息</td><td>$vo</td>"; echo "</tr>"; } else if($key == 'total_fee') { echo "<tr>"; echo "<td>支付总费用</td><td>￥".($vo/100)."元</td>"; echo "</tr>"; } ?>
              <!-- <tr>
              <td><?php echo ($key); ?></td>
              <td><?php echo ($vo); ?></td> --><?php endforeach; endif; else: echo "" ;endif; ?>
      </table>
