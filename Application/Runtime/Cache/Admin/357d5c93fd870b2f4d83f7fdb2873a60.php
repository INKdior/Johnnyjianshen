...
<div id="frameBord" name="frameBord"><div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">滚动广告banner</li>
        </ul><!-- .breadcrumb -->
    </div>
    <div class="add_cp">
        <form method="post"  action="<?php echo U('index/add_banner');?>" onsubmit="" id='subform'>
            <input  class="btn btn-default btn-sm" type="submit" value="添加banner" /> 
        </form>
    </div>
    <div class="table_con">
        <table>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td width="10%"><img width='100px' height='100px'src="<?php echo ($vo['imgurl']); ?>"></td>

                <td width="20%">
                    <a  class="sj_btn" href="<?php echo U('admin/index/details_banner',array('id'=>$vo['id']));?>">修改</a>  
                    <a  id="del" class="del_btn" href="javascript:" onclick=del("<?php echo U('admin/index/delbanner',array('id'=>$vo['id']));?>")>删除</a>
                </td>
